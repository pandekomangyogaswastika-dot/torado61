...
@router.get("/coa", deprecated=True)
async def list_coa_alias(
    ...
    """[DEPRECATED] Alias for /master/chart-of-accounts.

    DEPRECATED: use GET /api/master/chart-of-accounts (or the finance reporting
    endpoint GET /api/finance/chart-of-accounts). Kept for backward compat; not
    used by the current frontend (FE uses /api/finance/coa)."""
